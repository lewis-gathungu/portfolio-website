    ...
    <div className="whatIDO">
      ...
      <div className="what-box">
        <div className="what-box-in">
          ...
          {/* Card 3 - Entrepreneurial Leadership */}
          <div className="what-content what-noTouch" ref={(el) => setRef(el, 2)}>
            ...
            <div className="what-corner"></div>
            <div className="what-content-in">
              <h3>{config.skills.leadership.title}</h3>
              <h4>{config.skills.leadership.description}</h4>
              <p>{config.skills.leadership.details}</p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                {config.skills.leadership.tools.map((tool, index) => (
                  <div key={index} className="what-tags">{tool}</div>
                ))}
              </div>
              <div className="what-arrow"></div>
